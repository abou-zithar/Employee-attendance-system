...
class _ExcuseScreenState extends State<ExcuseScreen> {
          ...
          child: TextFormField(
            ...
            onTap: () async {
              ...
              if (timeOfDay != null) {
                {
                  setState(() {
                    selectedTime = timeOfDay.hour.toString() +
                        ":" +
  ...
  excuseRequestType() async {
    ...
    var request = http.Request(
        'GET', Uri.parse('http://13.79.147.127/EAT/API/api/LeaveTimeOff'));
